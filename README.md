...
<uses-permission android:name="android.permission.ACCESS_my_background_location"/> 
```
<!-- TODO: Fix example -->
<!-- ## Example -->
<!-- **[Complete working application Example](https://github.com/mamunru/my_background_location/tree/master/example)** -->
